# debian setup 
# minimal i3 installation
# keybindings are located in ~/.config/i3/config
...
# File Wallpapers 
curl -o ~/$config_ress/.wallpapers/name-goes-here.jpg https://url-goes-here.jpg
...
# Brightness bindings
bindsym XF86MonBrightnessUp exec --no-startup-id xrandr --output eDP-1 --brightness 0.8
...
bindsym $mod+p exec dmenu_run -fn 'Overpass Mono:pixelsize=15' -l 3 -nf '#707880' -sf '#cc6666' -nb '#1d1f21' -sb '#1d1f21'

# Unused cause i haven't had time to configure it yet so we will stick with dmenu
...
exec_always --no-startup-id feh --bg-fill ~/.wallpapers/s.jpg

exec_always --no-startup-id $HOME/.config/polybar/launch.sh
exec_always --no-startup-id wal -a70 -i ~/.wallpapers/s.jpg
